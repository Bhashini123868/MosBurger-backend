...
public class CustomerServiceImpl implements CustomerService {
    ...
    @Override
    public List<Customer> searchByContactInfo(Integer contactInfo) {
        List<CustomerEntity> byContactInfo = repository.findByContactInfo(contactInfo);
        List<Customer> customerList = new ArrayList<>();

        byContactInfo.forEach(customerEntity -> {
            customerList.add(mapper.map(customerEntity, Customer.class));
        });
        return customerList;
    }
